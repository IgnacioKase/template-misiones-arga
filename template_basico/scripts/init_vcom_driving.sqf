...
VCOM_fnc_IsDriver = compile preprocessFile "functions\fnc_IsDriver.sqf";
...
[] spawn 
{
  ...
  while {true} do 
  {
    ...
    sleep 0.25;
    {
      ...
      if (!(isplayer _x) && (_CheckVariable isEqualTo 0)) then {null = [_x] execFSM "functions\fnc_aiDriverBehavior.fsm";};
      };
    } forEach allUnits;
    sleep 5;
  };
